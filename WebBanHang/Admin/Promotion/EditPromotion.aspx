<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditPromotion.aspx.cs" Inherits="WebBanHang.Admin.Promotion.EditPromotion" %>
        ...
        <div class="form-row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input id="promotionID" runat="server" class="form-control" disabled="disabled" required="required" />
                </div>
                <div class="form-group">
