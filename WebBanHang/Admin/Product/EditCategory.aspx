<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditCategory.aspx.cs" Inherits="WebBanHang.Admin.Product.EditCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="container-fluid">
        <div class="form-group">
            ...
            <input id="categoryid" class="form-control" runat="server" disabled="disabled" />
        </div>
        <div class="form-group">
